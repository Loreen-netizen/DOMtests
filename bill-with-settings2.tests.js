...
it ("should update call total to R10 and total cost to R10 when call 5 Calls at R2each are made", function(){
...
it ("should update sms total to R4 and total cost to R4 when 4 sms' at R1each are made", function(){
    var billWithSettings7 = billWithSettingsFunction();
...
it ("should update sms total to R4.20 , call total to R4.80 and total cost to R9 when 3 sms' at R1.40 each and 2 calls at R 2.40 each are made", function(){
